...
{
    \ifthenelse{\equal{#1}{en}}{Research Statement and Proposal}{}
    \ifthenelse{\equal{#1}{de}}{Outline und Themenvorschlag}{}
}

\newcommand{\sectionQuestions}[1]
{
    \ifthenelse{\equal{#1}{en}}{\paragraph{Scope of Work.}}{}
    \ifthenelse{\equal{#1}{de}}{\section{Ziel der Arbeit - 4 Fragen}}{}
}

\newcommand{\sectionQuestionsDescription}[1]
{
    \ifthenelse{\equal{#1}{en}}{We briefly discuss the essence of the proposed research work. }{}
...
{
    \ifthenelse{\equal{#1}{en}}{\paragraph{Preliminary Table of Contents}}{}
...
{
    \ifthenelse{\equal{#1}{en}}{\subsection{Relevant Related Work}}{}
...
{
    \ifthenelse{\equal{#1}{en}}{In this section, we identify closely related works and their key ideas/contributions below:}{}
